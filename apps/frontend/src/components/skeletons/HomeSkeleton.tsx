      ...
      <main className="pt-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="py-16">
            <div className="w-48 h-8 bg-stone-700 rounded mb-4 animate-pulse"></div>
            <div className="w-full h-4 bg-stone-700 rounded mb-2 animate-pulse"></div>
            <div className="w-3/4 h-4 bg-stone-700 rounded animate-pulse"></div>
          </section>

          {/* New Posts Skeleton */}
          <section className="py-12 pb-16 max-w-[680px] w-full">
            <div className="flex items-center justify-between mb-5">
              <div className="w-24 h-6 bg-stone-700 rounded animate-pulse"></div>
