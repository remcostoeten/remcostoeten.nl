                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 sm:gap-6">
                            ...
                            <ContactPopover>
                                <button className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-background/50 border border-border/30 hover:border-accent/50 hover:bg-accent/10 transition-all duration-300 hover:scale-105">
