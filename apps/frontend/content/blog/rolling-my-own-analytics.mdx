...
You could just use something like [Posthog](https://posthog.com)or [Matomo](https://matomo.org), they’ve got funding and probably better engineers behind them than you and me. But hitting `npm install` and dropping in a provider doesn’t solve skillissues. 
...
## Stack & setup
Front-end we're using Next.JS. Why? Because. Since I want to learn fullstack development I went with Hono as a backend rather than server actions or api routes. 
