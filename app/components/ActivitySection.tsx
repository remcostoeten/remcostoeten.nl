...
export const ActivitySection = () => {
  ...
  return (
    <Fragment>
      <div 
        ref={activityRef}
        className="w-full rounded-xl border border-border/40 bg-muted/10 p-1 md:p-1.5 mb-12 animate-enter shadow-sm group transition-all duration-300 group-hover:border-border/60 group-hover:bg-muted/15"
      ...
      >
        ...
        {/* Hover line at top */}
        <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-green-500/0 via-green-500/60 to-green-500/0 opacity-0 group-hover:opacity-100 transition-all duration-500 scale-x-0 group-hover:scale-x-100 origin-center" />
