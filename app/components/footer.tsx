      ...
      <div className="max-w-3xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:text-right space-y-4">
            <div 
              className="inline-flex items-center gap-2 text-sm text-muted-foreground bg-background/30 px-3 py-1 rounded-full border border-border/20 backdrop-blur-sm self-start lg:self-end"
              style={stagger(0, 200)}
            >
              <div className={`w-2 h-2 ${statusOnline ? 'bg-green-500' : 'bg-gray-500'} rounded-full animate-pulse`} />
              <span>System Status: {statusOnline ? 'Online' : 'Offline'}</span>
            </div>
