					...
					>
						<div className="pt-4 space-y-4">
							<p className="text-sm text-muted-foreground/80 leading-relaxed font-mono tracking-tight px-4 md:px-5">
								These technologies are my daily drivers but
								certainly not exclusive. Aspiring full stack
								I've been exploring lower level languages like
								Rust for native development, golang for cli's
								and cutting-edge back-end frameworks like
								ElysiaJs.
							</p>
							<TechStackCloud />
						</div>
