...
/** @description Stacked photos with an arrow crossing from source to output. */
export function ImageConvertIcon(props: Props) {
	return (
		<svg {...iconProps(props)}>
			<rect x="2" y="4" width="12" height="12" rx="1.5" />
			<circle cx="6" cy="8" r="1.2" />
			<path d="m3.5 14 3.2-3 2.1 2 1.6-1.5 2.1 2.5" />
			<g className="g2v-arrow">
				<path d="M13 18h7" />
				<path d="m17.5 15.5 2.5 2.5-2.5 2.5" />
			</g>
		</svg>
	)
}
