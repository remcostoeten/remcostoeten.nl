      ...
      <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <div class="flex justify-center mt-6">
            <button
              class={['px-4 py-2 mx-1 font-semibold rounded-md',
                timeframe() === 'day' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border']}
            ...
            <button
              class={['px-4 py-2 mx-1 font-semibold rounded-md',
                timeframe() === 'week' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border']}
            ...
            <button
              class={['px-4 py-2 mx-1 font-semibold rounded-md',
                timeframe() === 'month' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border']}
