    ...
    return (
        <div 
            className={`p-3 rounded-lg border transition-colors ${
                isNew ? 'border-blue-200 bg-blue-50/50 dark:border-blue-900 dark:bg-blue-950/20' : 'bg-muted/30'
            }`}
        >
            ...
            <p 
                ...
                onClick={() => comment.content.length > 100 && setExpanded(!expanded)}
            >
                {comment.content}
            </p>
                        ...
                        {comments.length > 5 && (
                            ...
                            >
                                {showAll ? (
                                    ...
                                    <>View all {comments.length} comments <ChevronDown className="w-3 h-3" /></>
                                )}
                            </button>
                        )}
                    </>
