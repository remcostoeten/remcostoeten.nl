...
function BlogCard({ post }: { post: BlogPost }) {
    const isNew = new Date(post.metadata.publishedAt) > new Date(Date.now() - 7 * 24 * 60 * 60 * 1000)
                ...
                <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                            <Badge variant={post.metadata.draft ? "secondary" : "default"} className="text-[10px]">
                        ...
                        <h3 className="font-medium text-sm truncate" title={post.metadata.title}>
                            {post.metadata.title}
                        </h3>
        ...
        <Card>
            <CardHeader className="pb-4">
                ...
                <div className="flex items-center gap-2 mt-3">
                    ...
                    <SortButton field="views" currentField={sortField} direction={sortDirection} onSort={handleSort}>
                        <TrendingUp className="w-3 h-3" /> Views
                    </SortButton>
                    <SortButton field="date" currentField={sortField} direction={sortDirection} onSort={handleSort}>
                        <Calendar className="w-3 h-3" /> Date
                    </SortButton>
                    <SortButton field="title" currentField={sortField} direction={sortDirection} onSort={handleSort}>
