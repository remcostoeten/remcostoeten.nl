...
export default function SegmentEditor({ segment, onChange, onDelete }: SegmentEditorProps) {
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        >
          ...
          {segment.type === 'link' && segment.data?.url && (
            <span className="text-accent truncate max-w-20">{segment.data.url}</span>
          )}
        </button>
        <button
          onClick={onDelete}
