...
export const featuredProjects: IProject[] = [
  {
    name: "Skriuw",
    description: "Block-based workspace. Private, self-hostable, native desktop or web.",
    type: "desktop",
    status: "beta",
  ...
  {
    name: "Dora",
    description: "Native database manager for PostgreSQL, LibSQL, SQLite. No Electron.",
    type: "desktop",
    status: "wip",
...
export const otherProjects: IProject[] = [
  {
    ...
    description: "Performant interactive file tree visualization component with syntax highlighting",
    type: "ui",
    status: "done",
  ...
  },
  {
    ...
    description: "Feature-rich React codeblock component with syntax highlighting and copy",
    type: "ui",
    status: "done",
  ...
  },
  {
    ...
    description: "Dashboard for tracking Instagram followers with detailed snapshot reports",
    type: "saas",
    status: "wip",
  ...
  },
  {
    ...
    description: "CLI tool to auto-generate Turso/LibSQL databases and retrieve env credentials",
    type: "cli",
    status: "done",
  ...
  {
    name: "RYOA",
    description: "Roll your own auth in Next.js - JWT, Postgres, OAuth2, workspaces, invites",
    type: "utility",
    status: "done",
  ...
  },
  {
    ...
    description: "Visually build CSS variable or Tailwind 3/4 config from an image",
    type: "utility",
    status: "done",
  ...
  {
    name: "btwfyi",
    description: "Package for rendering task list in dev environment with shared DB adapters",
    type: "ui",
    status: "done",
  ...
  },
  {
    ...
    description: "Smart geolocation browser spoofer with React app and Chrome extension",
    type: "utility",
    status: "done",
  ...
  {
    name: "Fync",
    description: "Unified API for GitHub, GitLab, Vercel, Spotify, Notion, NPM and more",
    type: "utility",
    status: "wip",
  ...
  {
    name: "Servo",
    description: "Terminal dev launcher with various project management options",
    type: "cli",
    status: "done",
