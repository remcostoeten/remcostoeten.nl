    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button onClick={handleDeleteDemo} disabled={isActive} size="sm" variant="destructive">
            Delete Demo
          </Button>
          <Button onClick={handlePageLoadDemo} disabled={isActive} size="sm" variant="secondary">
            Page Load Demo
          </Button>
          <Button onClick={handleSimulateDemo} disabled={isActive} size="sm" variant="outline">
            Simulate Demo
          </Button>
        </div>
        
        <div className="flex gap-2">
          <Button onClick={handleManualStart} disabled={isActive} size="sm" variant="outline">
            Manual Start
          </Button>
          <Button onClick={handleManualStop} disabled={!isActive} size="sm" variant="outline">
            Manual Stop
          </Button>
        </div>
      </CardContent>
