		...
		<div ref={searchRef} className={`relative ${className}`}>
			<form onSubmit={handleSubmit}>
				<div className="relative">
					...
					<input
						...
						className="w-full pl-10 pr-10 py-2.5 sm:py-2 text-sm bg-background border border-border rounded-none focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all"
						role="combobox"
			...
			{isOpen && (
				<div
					...
					aria-busy={isLoading}
					className="absolute top-full left-0 right-0 mt-2 bg-background border border-border rounded-none shadow-lg z-50 max-h-80 overflow-y-auto"
				>
					{isLoading ? (
						<div
