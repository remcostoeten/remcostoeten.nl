      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-2.5 sm:py-2 text-sm bg-background border border-border rounded-none AAAA focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all"
            role="combobox"
