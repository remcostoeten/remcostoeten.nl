		...
		async function fetchGitHubData() {
			try {
				...
				const userResponse = await fetch(
					"https://api.github.com/users/remcostoeten",
					{
						headers: {
				...
				const reposResponse = await fetch(
					"https://api.github.com/users/remcostoeten/repos?sort=updated&per_page=6",
					{
						headers: {
							Accept: "application/vnd.github.v3+json",
							"User-Agent": "remcostoeten.nl-demo",
				...
				const commitPromises = repos
					.slice(0, 3)
					.map(async (repo: TGitHubRepo) => {
						try {
							const commitsResponse = await fetch(
								`https://api.github.com/repos/remcostoeten/${repo.name}/commits?per_page=3`,
								{
									headers: {
										Accept: "application/vnd.github.v3+json",
										"User-Agent": "remcostoeten.nl-demo",
