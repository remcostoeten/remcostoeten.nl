  ...
  return (
    <header className="px-4 md:px-5">
      ...
      <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <span className="font-semibold text-foreground"><AnimatedNumber value={8} duration={1200} group="hero" priority={0} initialProgress={0.75} /> years</span> of experience across{' '}
