        ...
        <div className="mt-2 p-4 bg-neutral-50 dark:bg-neutral-900/40 border border-neutral-200 dark:border-neutral-800 rounded-lg">
          <ul className="space-y-1">
            {headings.map((heading) => (
              ...
              >
                {heading.level > 2 && (
                  <span className="absolute left-[calc((var(--level)-2)*16px-8px)] top-1/2 -translate-y-1/2 w-1 h-1 rounded-full bg-neutral-300 dark:bg-neutral-700"
                ...
                <Link
                  ...
                  className={`block py-2 px-3 text-sm rounded-md transition-all duration-200 ${activeId === heading.id
                ...
                >
                  {heading.level > 2 && (
                    <span
                      ...
                      style={{ left: `${(heading.level - 2) * 14 - 8}px` }}
                    />
                  )}
                  <Link
                    href={`#${heading.id}`}
                    className={`block py-1.5 px-2.5 text-[13px] rounded-md transition-all duration-200 leading-snug ${activeId === heading.id
