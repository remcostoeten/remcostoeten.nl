                            ...
                            <div className="px-6 py-8">
                                <div className="text-center space-y-6">
                                    ...
                                    <button
                                        ...
                                        disabled={isLoading}
                                        className="w-full px-6 py-3 bg-white hover:bg-zinc-200 text-zinc-900 font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {isLoading ? (
