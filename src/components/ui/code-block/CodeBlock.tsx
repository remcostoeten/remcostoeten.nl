                ...
                lineProps: (lineNumber) => {
                  const isContextLine =
                    ...
                    (lineNumber <= beforeLineCount ||
                      lineNumber > beforeLineCount + mainLineCount);
                  ...
                  return {
                    style: {
                      ...
                      paddingLeft: "3.5rem",
                      position: "relative",
                      backgroundColor: shiftedHighlightLines.includes(
                        lineNumber,
                      )
                        ? "rgba(163, 230, 53, 0.05)"
                        : "transparent",
                      borderLeft: shiftedHighlightLines.includes(lineNumber)
                        ? "2px solid #a3e635"
              ...
              <pre className="m-0 overflow-x-auto bg-transparent text-[0.8125rem] leading-[1.7] text-[hsl(var(--sh-text))]">
                <code className="block font-mono">
                  {displayLines.map((line, index) => {
                    ...
                    const isContextLine =
                      hasContext &&
                      (visualLineNumber <= beforeLineCount ||
                        visualLineNumber > beforeLineCount + mainLineCount);
                    const isHighlighted =
                      shiftedHighlightLines.includes(visualLineNumber);
