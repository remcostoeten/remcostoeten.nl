...
function generateExternalUrls(trackName: string, artistName: string): TExternalUrl[] {
      ...
      <PopoverContent className="w-80 p-4">
        <div className="flex gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-muted-foreground truncate mt-1" title={track.album}>
              {track.album}
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 space-y-2">
          <h4 className="text-sm font-medium text-muted-foreground">Listen on:</h4>
