...
const termsCopy: Record<LegalLanguage, TermsCopy> = {
	en: {
		...
		canDo: [
			...
			{
				title: 'Interact',
				body: 'Leave thoughtful comments and reactions on blog posts using GitHub authentication.'
			},
			{
				title: 'Contact',
	...
	nl: {
		...
		license:
			'Tenzij anders vermeld zijn de inhoud en codevoorbeelden hier MIT-gelicentieerd. Je mag ze kopiëren, hergebruiken of aanpassen zolang je de licentie en naamsvermelding behoudt.',
		canDo: [
			{
				title: 'Lezen en delen',
				body: 'Lees, deel en bespreek gerust berichten. Een linkje wordt gewaardeerd.'
			},
			{
				title: 'Code hergebruiken',
				body: 'Codefragmenten en voorbeelden zijn MIT-gelicentieerd tenzij een bestand anders aangeeft.'
			},
			{
				title: 'Reageren',
				body: 'Laat doordachte reacties en reacties achter via GitHub-authenticatie.'
			},
			{
				title: 'Contact opnemen',
				body: 'Neem contact op met vragen, samenwerkingen of feedback.'
			}
		],
		cannotDo: [
			{
				title: 'Naamsvermelding verwijderen',
				body: 'Verwijder de MIT-licentie niet en doe geen verkeerde voorstelling van auteurschap.'
			},
			{
				title: 'Misbruik van het platform',
				body: 'Geen spam, intimidatie of ongepast gedrag in reacties of contactformulieren.'
			},
			{
				title: 'Onzorgvuldig scrapen',
				body: 'Gebruik scrapers verantwoord. De site overbelasten of beveiliging omzeilen mag niet.'
			},
			{
				title: 'Beveiliging omzeilen',
				body: 'Probeer geen beveiligingsmaatregelen te omzeilen of privéfuncties te reverse-engineeren.'
			}
		],
		myContent: {
		...
		fairUse:
			'Beperkte citaten en delen voor educatieve doeleinden, commentaar of kritiek zijn welkom binnen de regels van fair use, mits met juiste naamsvermelding.',
		authIntro:
			'Deze site gebruikt GitHub OAuth voor authenticatie. Door in te loggen:',
		authBullets: [
		...
		authNote:
			'Ik gebruik alleen de minimale gegevens die nodig zijn voor authenticatie en personalisatie.',
		privacyIntro:
			'Je privacy is belangrijk. In de Privacyverklaring lees je:',
		privacyBullets: [
		...
		privacyNote:
			'Door deze site te gebruiken ga je akkoord met de gegevensverwerking zoals beschreven in de Privacyverklaring.',
		accuracy:
			'Ik doe mijn best om nauwkeurige informatie te bieden, maar inhoud kan fouten bevatten of verouderen. Technische tutorials werken mogelijk niet in elke omgeving. Gebruik is op eigen risico.',
		advice: 'Dit is een persoonlijk blog, geen professioneel advies. Inhoud weerspiegelt mijn eigen mening en ervaring.',
		availability:
			'Dit is een persoonlijke website, geen commerciële dienst. Ik houd de site zo goed mogelijk draaiend, maar:',
		availabilityBullets: [
			{
		...
		availabilityNote:
			'Deze dienst wordt “zoals hij is” aangeboden, zonder garanties.',
		...
		contact:
			'Je kunt per mail contact opnemen. Ik probeer te antwoorden maar kan geen reactie garanderen. Andere kanalen zijn LinkedIn of GitHub.'
	}
}
