            ...
            >
              ...
              <article className="relative flex items-center justify-between gap-4 py-8 px-6 border-b border-neutral-800/40 z-10">
                ...
                <div className="flex-shrink-0">
                  <div className="relative w-12 h-12 rounded-full bg-neutral-800/50 group-hover:bg-lime-400/20 flex items-center justify-center overflow-hidden transition-colors">
                    <ArrowUpRight className="absolute w-5 h-5 text-neutral-500 group-hover:text-lime-400 transition-all duration-150 group-hover:-translate-y-6 group-hover:translate-x-6" />
                    <ArrowUpRight className="absolute w-5 h-5 text-lime-400 -translate-x-6 translate-y-6 transition-all duration-150 group-hover:translate-x-0 group-hover:translate-y-0" />
                  </div>
                </div>
              </article>
            </Link>
