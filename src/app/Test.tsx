	...
	return (
		<svg
			...
			style={{
				opacity,
				animation: animate
					? `dot-move-${patternId} ${duration}s linear infinite`
					: 'none',
	...
	return (
		<div
			...
			style={{
				...
				animation: animate
					? `line-anim-${animId} ${duration}s linear infinite`
					: 'none',
				animationDelay: `${delay}s`
			}}
			aria-hidden="true"
...
export function SectionHeading({
	...
	const duration =
		animationSpeed ??
		(typeof bgAnimation === 'string'
			? ANIMATION_DURATIONS[bgAnimation]
			...
			>
				...
				>
					...
					<div className="flex items-center gap-2">
						...
						<span
							className={`${SECTION_HEADING_DEFAULTS.fontSize.left} ${colors.leftText} select-text`}
						>
							{leftText}
						</span>
					</div>
