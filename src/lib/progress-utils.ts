import { startProgress, stopProgress, incrementProgress, setProgress } from './progress-indicator';
...
export async function progressForSaving<T>(saveFn: () => Promise<T>): Promise<T> {
...
export async function progressForDeleting<T>(deleteFn: () => Promise<T>): Promise<T> {
...
export async function progressForPageLoad<T>(loadFn: () => Promise<T>): Promise<T> {
