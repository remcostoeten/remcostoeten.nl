...
async function seedHomePage() {
    ...
    await db.insert("content_segments").values({
        id: nanoid(),
    ...
    const contentSegments = [
        ...
        { text: ", I specialize in building scalable web applications, from Magento shops to modern SaaS platforms. Currently working on an ", type: "text" },
...
seedHomePage().then(() => console.log('Seeding complete')).catch(console.error);
