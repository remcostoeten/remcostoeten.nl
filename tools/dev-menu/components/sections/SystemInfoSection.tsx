					...
					>
						<div className="px-4 py-2 space-y-1.5 text-[10px]">
							<div className="flex justify-between border-b border-[hsl(0,0%,18%)] pb-1">
								<span className="text-[hsl(0,0%,40%)] uppercase">
									env
								</span>
								<span className="text-[hsl(167.8,53.25%,65%)]">
							...
							<div className="flex justify-between border-b border-[hsl(0,0%,18%)] pb-1">
								...
								<span className="text-[hsl(0,0%,55%)] truncate max-w-[120px]">
									{process.env.NEXT_PUBLIC_ADMIN_EMAIL ||
										'n/a'}
								</span>
							</div>
							<div className="space-y-0.5">
								<span className="text-[hsl(0,0%,40%)] uppercase block">
									ua
								</span>
